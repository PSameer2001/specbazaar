        ...
        <div class="p-5">
            ...
            <section class="balance-info">
                <div class="row">
                    ...
                    <?php
                        $sql3 = "SELECT SUM(total) as total_price FROM orders WHERE invoice_no='$invoice_no'";
                        $res3 = mysqli_query($conn,$sql3);
                        while($row3 = mysqli_fetch_assoc($res3)){
                            $total = $row3['total_price'];
                        }
                        $sql4 = "SELECT * FROM shipping_charge";
                        $res4 = mysqli_query($conn,$sql4);
                        $row4 = mysqli_fetch_assoc($res4);
                        $shipping_charge = $row4['charge'];
                    ?>
                    <div class="col-4">
                        <table class="table border-0 table-hover">
                            ...
                            <tfoot>
                                <tr>
                                    <td>Total:</td>
                                    <td>&#8377; <?php echo $total+$shipping_charge; ?></td>
                                </tr>
                            </tfoot>
                        </table>

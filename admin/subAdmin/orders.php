...
<div class="main-content ppd">
    <div class="wrapper">
    <a href="<?php echo SITEURL; ?>admin/subAdmin/createOrder.php"><button class="addButton">Add Product</button></a>
    <form action="subOrderSearch.php" method="get" class="search-form">
...
<div class="row">
            ...
            <?php
            $sql = "SELECT * FROM orders WHERE publisher='$publisher'";
            ...
            if($count>0)
            {
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo SITEURL; ?>admin/subAdmin/updateOrder.php?id=<?php echo $id; ?>"><button class="updatebtn">

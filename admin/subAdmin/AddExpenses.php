<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if($res==true){
        ?>
            <script>window.location.href='<?php echo SITEURL ?>admin/subAdmin/Expenses.php'</script>
        <?php
        }else{
            ?>
            <script>window.location.href='<?php echo SITEURL ?>admin/subAdmin/addExpenses.php'</script>
            <?php
        }
    }
?>

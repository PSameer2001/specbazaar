...
<section class="registration">
        <form action="subEyeTest.php" method="get" class="search-form">
...
<?php
            ...
            $sql = "SELECT * FROM eye_test WHERE tester='$user' AND (username LIKE '%$search%' OR email LIKE '%$search%' OR contact LIKE '%$search%' OR visited LIKE '%$search%' OR tester LIKE '%$search%')";
...
?>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="sppc">
                        <a href="<?php echo SITEURL; ?>admin/superAdmin/updateHomeEyeTest.php?id=<?php echo $id; ?>" ><button class="updatebtn btn9">

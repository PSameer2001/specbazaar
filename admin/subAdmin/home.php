...
?>
    ...
    <div class="main-content ppd">
        <div class="row row-cols-4"><div class="col-md-10 col-12">
                    <h3>Shop Name : <?php echo $_SESSION['sub_branch_name']; ?></h3>
                    <p>owner name : <?php echo $_SESSION['subAdmin']; ?></p>
                    <p>contact number : <?php echo $_SESSION['sub_contact']; ?></p>
                    <p>address : <?php echo $_SESSION['sub_address']; ?></p>
                </div>

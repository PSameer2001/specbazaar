...
<div class="main-content ppd">
    <div class="wrapper">
        ...
        ?>
         <a href="<?php echo SITEURL; ?>admin/subAdmin/addExpenses.php"><button class="addButton">Add Expenses</button></a>
        ...
        <?php
            ...
            if($count>0)
            {
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo SITEURL; ?>admin/subAdmin/updateExpense.php?id=<?php echo $id; ?>" ><button class="updatebtn">

...
<div class="signup-form-container1 ">
            ...
            $sql = "SELECT * FROM inventory WHERE title LIKE '%$search%' OR description LIKE '%$search%' OR price LIKE '%$search%' OR brand LIKE '%$search%' OR color LIKE '%$search%'";
            $sn=1;
    ...
    ?>
                ...
                <tr>
                    ...
                    <td class="sppc">
                        <a href="<?php echo SITEURL; ?>admin/superAdmin/updateInventoryProduct.php?id=<?php echo $id; ?>"><button type="button" class="updatebtn btn9">
  <span class="label">Update</span></button></a>

                        <a href="<?php echo SITEURL; ?>admin/superAdmin/deleteInventoryProduct.php?id=<?php echo $id; ?>&image_name=<?php echo $image_name;?>" class="btn-danger">

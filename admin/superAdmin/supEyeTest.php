...
<?php
            $search = $_GET['search'];
            $sql = "SELECT * FROM eye_test WHERE username LIKE '%$search%' OR email LIKE '%$search%' OR contact LIKE '%$search%' OR visited LIKE '%$search%' OR tester LIKE '%$search%'";
...
?>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="sppc">
                        <a href="<?php echo SITEURL; ?>admin/superAdmin/updateHomeEyeTest.php?id=<?php echo $id; ?>" ><button type="button" class="updatebtn btn9">

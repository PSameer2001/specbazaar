...
<form action="supHomeTrySearch.php" method="get" class="search-form">
...
<?php
            $search = $_GET['search'];
            $sql = "SELECT * FROM home_try_on WHERE username LIKE '%$search%' OR username LIKE '%$search%' OR email LIKE '%$search%' OR contact LIKE '%$search%'";

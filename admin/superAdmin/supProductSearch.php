...
<section class="registration">
    <form action="supProductSearch.php" method="get" class="search-form">
 ...
 <div class="signup-form-container1 ">
                                ...
                                <table class="table table-hover">
                                    <thead class="text-primary">
                                        <tr>
                                            ...
                                            <th class="sppc">Discounted Price</th>
            ...
            <?php
            $search = $_GET['search'];
            $sql = "SELECT * FROM products WHERE title LIKE '%$search%' OR description LIKE '%$search%' OR product_code LIKE '%$search%' OR color LIKE '%$search%'";
            $sn=1;
    ...
    ?>
                ...
                <tr>
                    ...
                    <td class="sppc"><?php echo $discounted_price; ?></td>
                    <td class="sppc">

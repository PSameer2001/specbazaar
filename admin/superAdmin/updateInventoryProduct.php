...
<?php 
    ...
    {
        ?>
        <script>window.location.href='<?php echo SITEURL; ?>admin/superAdmin/manageInventoryProducts.php?id=<?php echo $id ?>';</script>
        <?php
    }
?>
        ...
        <?php
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name'])){
                    ...
                    if($image_name!=""){
                        ...
                        if($upload==false)
                        {
                            ...
                            ?>
                            <script>window.location.href='<?php echo SITEURL; ?>admin/superAdmin/updateInventoryProduct.php';</script>
                            <?php
                            die();
                        }
                        if($current_image!="")
                ...
                if($res3==true)
                {
                    ...
                    ?>
                    <script>window.location.href='<?php echo SITEURL; ?>admin/superAdmin/manageInventoryProducts.php';</script>
                    <?php
                }
                else
                {

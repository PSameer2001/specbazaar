        ...
        <table class="tbl-30">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input <?php if($recommend=="No") {echo "checked";} ?> type="radio" id="cmpo" name="recommend" value="No"> No 
                </td>
            </tr>
            ...
            <tr>
                <td><p>Banner:  </p></td>
                <td>
                    <input <?php if($banner=="Yes") {echo "checked";} ?> type="radio" id="cmpo" name="banner"  value="Yes"> Yes 
                    <input <?php if($banner=="No") {echo "checked";} ?> type="radio" id="cmpo" name="banner" value="No"> No 
                </td>
            </tr>

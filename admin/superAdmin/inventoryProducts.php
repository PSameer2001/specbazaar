...
<div class="main-content ppd">
    <div class="wrapper">
<a href="<?php echo SITEURL; ?>admin/superAdmin/addInventory.php"><button class="addButton">Add Inventory Product</button></a>
<form action="supInventorySearch.php" method="get" class="search-form">

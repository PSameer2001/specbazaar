...
<div class="main-content ppd">
    <div class="wrapper">
        ...
        ?>
        <a href="<?php echo SITEURL; ?>admin/superAdmin/addSubAdmin.php"><button class="addButton">Add Sub Admin</button></a>
        <br><br><br>
        <div class="row ">
        ...
        <?php
            ...
            if($count>0)
            {
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo SITEURL;?>admin/superAdmin/changeSubAdminPassword.php?id=<?php echo $id; ?>"><button class="btn9">Change Password</button></a>
                        <a href="<?php echo SITEURL; ?>admin/superAdmin/updateSubAdmin.php?id=<?php echo $id; ?>"><button class="updatebtn">
